...
[![Maven Central](https://img.shields.io/maven-central/v/com.abahgat/suffixtree)](https://central.sonatype.com/artifact/com.abahgat/suffixtree)
...
Unlike common suffix trees, which are generally used to build an index out of one (very) long string, a _Generalized Suffix Tree_ can be used to build an index over many strings.
...
The overall complexity of the retrieval operation (`search`) is _O(m)_ where _m_ is the length of the string to search within the index.
